                ...
                <x-jet-authentication-card>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="input-group mt-4">
                            ...
                            <x-jet-input id="email" placeholder="E-mail" class="form-control" type="email" name="email"
                        ...
                        <div class="input-group mt-4">
                            ...
                            <x-jet-input id="name" placeholder="Usuário" class="form-control" type="text" name="name"
                        ...
                        <div class="input-group mt-4">
                            ...
                            <x-jet-input id="password_confirmation" placeholder="Confirmar Senha" class="form-control"
